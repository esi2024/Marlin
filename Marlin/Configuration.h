 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 536.91, 500 }
...
#define Z_AFTER_HOMING         8   // (mm) Height to move to after homing (if Z was homed)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 31  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 71  // (mm) Y point for Z homing
